...
"""FE01 STEP68 / L6.73.8 quick compatibility verifier for historical L661 release evidence.
...
REPORTS = Path(os.environ.get("LINYUANZHE_REPORT_DIR") or tempfile.mkdtemp(prefix="linyuanzhe_verify_l661_"))
CONTRACT_VERSION = "tiangong.l6_61.release_verify.quick_compat.v2"
...
def main() -> int:
    ...
    summary: dict[str, Any] = {
        ...
        "skip_reason": "Historical L661 compile/preflight chain is superseded by the current L6.73.8 verifier; default mode is package-read-only and CI-safe.",
        ...
        "checks": checks,
        "note": "L6.61 real Runtime unlock remains explicit/opt-in; absent URL is not a release failure in this quick wrapper.",
    }
