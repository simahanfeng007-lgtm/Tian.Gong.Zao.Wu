...
"""FE01 STEP68 / L6.73.8 quick compatibility verifier for historical L660 release evidence.
...
REPORTS = Path(os.environ.get("LINYUANZHE_REPORT_DIR") or tempfile.mkdtemp(prefix="linyuanzhe_verify_l660_"))
CONTRACT_VERSION = "tiangong.l6_60.release_verify.quick_compat.v2"
...
def main() -> int:
    ...
    summary: dict[str, Any] = {
        ...
        "skip_reason": "Historical L660 compile/preflight chain is superseded by the current L6.73.8 verifier; default mode is package-read-only and CI-safe.",
        ...
        "checks": checks,
        "note": "L6.60 legacy gate retained as compatibility evidence only.",
    }
