...
"""FE01 STEP68 / L6.73.8 quick compatibility verifier for historical L6708 release evidence.
...
REPORTS = Path(os.environ.get("LINYUANZHE_REPORT_DIR") or tempfile.mkdtemp(prefix="linyuanzhe_verify_l6708_"))
CONTRACT_VERSION = "tiangong.l6_70_8.release_verify.quick_compat.v2"
...
def main() -> int:
    ...
    summary: dict[str, Any] = {
        ...
        "skip_reason": "Historical L6708 compile/preflight chain is superseded by the current L6.73.8 verifier; default mode is package-read-only and CI-safe.",
        ...
        "checks": checks,
        "note": "L6.70.8 desktop transcript verifier is historical compatibility only; real desktop acceptance is opt-in.",
    }
