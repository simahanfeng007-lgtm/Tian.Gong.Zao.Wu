...
"""FE01 STEP68 / L6.73.8 quick compatibility verifier for historical L664 release evidence.
...
REPORTS = Path(os.environ.get("LINYUANZHE_REPORT_DIR") or tempfile.mkdtemp(prefix="linyuanzhe_verify_l664_"))
CONTRACT_VERSION = "tiangong.l6_64.release_verify.quick_compat.v2"
...
def main() -> int:
    ...
    summary: dict[str, Any] = {
        ...
        "skip_reason": "Historical L664 compile/preflight chain is superseded by the current L6.73.8 verifier; default mode is package-read-only and CI-safe.",
        ...
        "checks": checks,
        "note": "L6.64 file-transfer/interrupt preflight is not rerun by default to avoid CI hangs.",
    }
