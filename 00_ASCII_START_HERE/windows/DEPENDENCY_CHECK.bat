...
rem ENTRY_KIND=dependency_check
...
set "SCRIPT_DIR=%~dp0"
set "START_DIR=%CD%"
set "TITLE=FE01 STEP68 / L6.73.8 - DEPENDENCY"
set "SAFE_LAUNCHER="
title %TITLE%
...
%PY_CMD% -S -B -u "%SAFE_LAUNCHER%" --entry-kind "dependency_check" --python-entry "00_ASCII_START_HERE\python\DEPENDENCY_CHECK.py" --title "FE01 STEP68 / L6.73.8 - DEPENDENCY" --python-mode "plain" --launcher-dir "%SCRIPT_DIR%" --start-dir "%START_DIR%" 
set "RC=%ERRORLEVEL%"
