...
rem ENTRY_KIND=start_desktop_auto
...
set "SCRIPT_DIR=%~dp0"
set "START_DIR=%CD%"
set "TITLE=FE01 STEP68 / L6.73.8 - AUTO"
set "SAFE_LAUNCHER="
title %TITLE%
...
%PY_CMD% -S -B -u "%SAFE_LAUNCHER%" --entry-kind "start_desktop_auto" --python-entry "00_ASCII_START_HERE\python\START_DESKTOP_L6710.py" --title "FE01 STEP68 / L6.73.8 - AUTO" --python-mode "tk" --launcher-dir "%SCRIPT_DIR%" --start-dir "%START_DIR%" --backend-mode auto
set "RC=%ERRORLEVEL%"
