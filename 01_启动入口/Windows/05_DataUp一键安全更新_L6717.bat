...
rem ENTRY_KIND=dataup_safe_update
...
set "SCRIPT_DIR=%~dp0"
set "START_DIR=%CD%"
set "TITLE=FE01 STEP68 / L6.73.8 - DATAUP"
set "SAFE_LAUNCHER="
title %TITLE%
...
%PY_CMD% -S -B -u "%SAFE_LAUNCHER%" --entry-kind "dataup_safe_update" --python-entry "00_ASCII_START_HERE\python\DATAUP_SAFE_UPDATE_L6717.py" --title "FE01 STEP68 / L6.73.8 - DATAUP" --python-mode "plain" --launcher-dir "%SCRIPT_DIR%" --start-dir "%START_DIR%" 
set "RC=%ERRORLEVEL%"
