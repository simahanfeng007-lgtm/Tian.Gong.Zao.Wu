...
def main() -> int:
    ...
    good_events = [
        RuntimeSseEvent(event="run_started", seq=1, run_id="run-l663", task_id="tamockkey_l663", payload={"runtime_status": "active"}),
        RuntimeSseEvent(event="quality_gate", seq=2, run_id="run-l663", task_id="tamockkey_l663", payload={"risk_level": "A3", "decision": "allowed", "gate_id": "gate-l663"}),
        RuntimeSseEvent(event="assistant_final", seq=3, run_id="run-l663", task_id="tamockkey_l663", payload={"content": "HookBus smoke ok", "status": "ok"}),
        RuntimeSseEvent(event="run_terminal", seq=4, run_id="run-l663", task_id="tamockkey_l663", payload={"status": "ok"}),
    ]
