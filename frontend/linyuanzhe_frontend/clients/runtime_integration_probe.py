...
SECRET_RENDER_MARKERS = (
    ...
    "Bearer ",
    "api_key=",
    "credential_l6738_secret",
)


class RuntimeIntegrationProbe:
    """L6.73.8 frontend/backend integration probe.
    ...
    def __init__(
        ...
        *,
        ...
        validate_url(cleaned, allow_loopback_http=True, purpose="runtime_probe_base_url")
        ...
        try:
            req = urllib.request.Request(
                ...
                headers={
                    ...
                    "X-Tiangong-Frontend-Contract": "L6.73.8",
                },
            )
            with urlopen_with_policy(req, timeout=self.timeout, allow_loopback_http=True, purpose="runtime_probe") as resp:
                ...
                provider_write_ack = self.client.submit_provider_settings(
                    {
                        ...
                        "api_key": "credential_l6738_secret",
                        "base_url": "provider-write-l6738.local/v1",
                    }
                )
