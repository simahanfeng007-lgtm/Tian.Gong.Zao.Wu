...
def main() -> int:
    ...
    ok = (
        ...
        and not re.search(r"(?i)sk-[A-Za-z0-9_\-]{12,}", public_text)
    ...
    print(json.dumps({
        ...
        "raw_secret_leaked": bool(re.search(r"(?i)sk-[A-Za-z0-9_\-]{12,}", public_text) or re.search(r"(?i)Bearer\s+[A-Za-z0-9_\-.]{12,}", public_text)),
