...
PHASE5_FILES = {
    "boundary_request.py",
    "boundary_review_advice.py",
    "boundary_route_advice.py",
    "execution_request.py",
    "execution_routing_advice.py",
    "boundary_execution_math.py",
    "boundary_execution_transition.py",
}
...
def test_l3_phase5_source_has_no_real_l5_l4_execution_or_side_effects():
    violations = []
